...
export function GallerySection() {
  ...
  return (
    <section id="gallery" className="section-padding-compact section-warm-accent relative overflow-hidden">
      <div
      ...
      <Container className="relative">
        ...
        >
          {GALLERY_IMAGES.map((img) => (
            <motion.div key={img.id} variants={fadeInUp} className="h-full">
              <GalleryCard
                src={img.src}
